  ...
  Widget _buildCircleChild(int index, bool oldState) {
    ...
    switch (state) {
      ...
      case StepState.complete:
       // return Container(decoration: BoxDecoration(shape: BoxShape.circle,border: Border.all(color: primaryColor,width: 2)),child: Icon(Icons.check,size: 18,color: primaryColor,),);
        return Icon(
          Icons.check,
          // color: primaryColor,
          color: !isDarkActive ? _kCircleActiveDark : _kCircleActiveLight,
