...
int index=-1;
            ...
            children: [
              ...
              Expanded(
                child: GridView.count(
                  ...
                  children: List.generate(_getTimeSlots().length, (index) {
                    return Padding(
                      ...
                      child: Container(
                        child: InkWell(
                            onTap: () {
                              this.index=index;
                             data.setTimeslot(_getTimeSlots()[index]);
                            },
                            child: timePicker(
                              time: _getTimeSlots()[index],
  ...
  List _getTimeSlots() {
    ...
    for (int i = 0; i < list.length; i++) {
      datadatalist.add(list[i].toString() + " - " + list[++i].toString());
    }
    return datadatalist;
  }
}
...
Widget timePicker({
  ...
  return Container(
    ...
    width: Get.width * .37,
    decoration: BoxDecoration(
        border: Border.all(width: 1, color: isSelected? Colors.blue : borderColor),
        borderRadius: BorderRadius.circular(25)),
    child: Center(
        child: InkWell(
      child: Text(
        time,
        style: TextStyle(fontWeight: FontWeight.bold, color:isSelected? Colors.blue : timeColor),
      ),
    )),
  );
}

Widget invoiceBottomSheet() {
  return Consumer<DashboardProvider>(builder: (build,data,child){
    return Container(
      width: Get.width,
...
getServicePrice(DashboardProvider data) {
